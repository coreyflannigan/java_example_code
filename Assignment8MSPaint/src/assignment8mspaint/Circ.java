...
/**
 * This is the Circ class, extended from Shape, that is used to draw a circle
...
public class Circ extends Shape {
    ...
    /**
     * Circ constructor called from the main program, takes in 5 variables then
     * passes those to its super class to store them and create the Circ object
     * 
     ...
     */
    public Circ(double x, double y, double width, double height, Color color){
        super(x, y, width, height, color);
    }
    
    /**
     * Draw method called from main program, uses the 5 stored variables in its
     * super class to draw a filled in circle on the canvas, as well as a
     * different colored border around the circle
     * 
